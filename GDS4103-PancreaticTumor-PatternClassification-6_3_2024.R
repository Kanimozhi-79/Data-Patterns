...
######################################
###       1.      "F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_1_8490genes.csv"
###       2.      "F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_2_8577genes.csv"
###       3.      "F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_3_8689genes.csv"
###       4.      "F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_4_8484genes.csv"
###       5.      "F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_5_8603genes.csv"
###       6.      "F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_6_8601genes.csv"
###       7.      "F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_7_3231genes.csv"
###                Genes---54675
###               Samples---78
###               Tumor --  1:39
###               Normal--  40:78
start_time <- Sys.time()
a<-read.csv("F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_1_8490genes.csv",header=TRUE)
b<-read.csv("F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_2_8577genes.csv",header=TRUE)
c<-read.csv("F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_3_8689genes.csv",header=TRUE)
d<-read.csv("F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_4_8484genes.csv",header=TRUE)
e<-read.csv("F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_5_8603genes.csv",header=TRUE)
f<-read.csv("F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_6_8601genes.csv",header=TRUE)
g<-read.csv("F:/Ph.D Work/R/Coding/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_7_3231genes.csv",header=TRUE)

inputdata1=data.frame(matrix(NA,nrow=78,ncol=0))
...
New_DF_EO=data.frame(matrix(NA,nrow=78,ncol=0))

New_DF_CE=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_CE_NT=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_CE_TN=data.frame(matrix(NA,nrow=78,ncol=0))

New_DF_TBE=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_TBE_NT=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_TBE_TN=data.frame(matrix(NA,nrow=78,ncol=0))

New_DF_BBE=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_BBE_NT=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_BBE_TN=data.frame(matrix(NA,nrow=78,ncol=0))
...
New_DF_PO=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_Names=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_PO_TN=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_PO_NT=data.frame(matrix(NA,nrow=78,ncol=0))

# Creating new DataFrame to append cOMPLETELY separation classes
#change nrow when Dataset changed
New_DF_TBBO=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_TBBO_Names=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_TBBO_TN=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_TBBO_NT=data.frame(matrix(NA,nrow=78,ncol=0))

# Creating new DataFrame to append cOMPLETELY separation classes
#change nrow when Dataset changed
New_DF_CS=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_CS_Names=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_CS_NT=data.frame(matrix(NA,nrow=78,ncol=0))
New_DF_CS_TN=data.frame(matrix(NA,nrow=78,ncol=0))
...
for(i in 1:cols){ #n Number of features
  Tumor_min<-round(min(inputdata1[1:39,i]),digits=1) #No of Tumor Samples
  Tumor_max<-round(max(inputdata1[1:39,i]),digits=1)
  Tumor_min=as.numeric(Tumor_min)
  Tumor_max=as.numeric(Tumor_max)
  
  Normal_min<-round(min(inputdata1[40:78,i]),digits=1) #No of Normal Samples
  Normal_max<-round(max(inputdata1[40:78,i]),digits=1)
...
print(paste("Length of New_DF_PO=",length(New_DF_PO_NT)))
print(paste("Length of New_DF_PO=",length(New_DF_PO_TN)))

print(paste("Length of New_DF_TBBO=",length(New_DF_TBBO)))
print(paste("Length of New_DF_TBBO=",length(New_DF_TBBO_NT)))
print(paste("Length of New_DF_TBBO=",length(New_DF_TBBO_TN)))
...
Gene_Num_Summary
write.csv(Gene_Num_Summary,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/GDS4103_Gene_Summary_DF.csv",row.names = F)
...
DF_Summary
write.csv(DF_Summary,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/GDS4103_DF_Summary.csv",row.names = F)
...
DF_Summary_Sub
write.csv(DF_Summary_Sub,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/GDS4103_DF_Summary_Sub_Summary.csv",row.names = F)
...
PO_DF_Summary
write.csv(PO_DF_Summary,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Significant-Patterns/PO/GDS4103_PO_DF_Summary.csv",row.names = F)
...
write.csv(po1,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Significant-Patterns/PO/GDS4103_PO_MinMax_Vectors_NT.csv",row.names = F)
length(po1)
...
write.csv(po2,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Significant-Patterns/PO/GDS4103_PO_MinMax_Vectors_TN.csv",row.names = F)
length(po2)
...
write.csv(po,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Significant-Patterns/PO/GDS4103_PO_MinMax_Vectors.csv",row.names = F)
length(po)
...
write.csv(eo,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/EO/GDS4103_EO_MinMax_Vectors.csv",row.names = F)
length(eo)
...
write.csv(ce1,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/CE/GDS4103_CE_MinMax_Vectors_NT.csv",row.names = F)
length(ce1)
...
write.csv(ce2,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/CE/GDS4103_CE_MinMax_Vectors_TN.csv",row.names = F)
length(ce2)
...
write.csv(ce,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/CE/GDS4103_CE_MinMax_Vectors.csv",row.names = F)
length(ce)
...
write.csv(tbe1,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/LMO-UME/GDS4103_LMO-UME_MinMax_Vectors_NT.csv",row.names = F)
length(tbe1)
...
write.csv(tbe2,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/LMO-UME/GDS4103_LMO-UME_MinMax_Vectors_TN.csv",row.names = F)
length(tbe2)
...
write.csv(tbe,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/LMO-UME/GDS4103_LMO-UME_MinMax_Vectors.csv",row.names = F)
length(tbe)
...
write.csv(bbe1,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/UMO-LME/GDS4103_UMO-LME_MinMax_Vectors_NT.csv",row.names = F)
length(bbe1)
...
write.csv(bbe2,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/UMO-LME/GDS4103_UMO-LME_MinMax_Vectors_TN.csv",row.names = F)
length(bbe2)
...
write.csv(bbe,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/UMO-LME/GDS4103_UMO-LME_MinMax_Vectors_TN.csv",row.names = F)
length(bbe)
...
write.csv(New_DF_EO,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/EO/GDS4103_New_DF_EO.csv",row.names = F)

write.csv(New_DF_CE,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/CE/GDS4103_New_DF_CE.csv",row.names = F)
write.csv(New_DF_CE_NT,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/CE/GDS4103_New_DF_CE_NT.csv",row.names = F)
write.csv(New_DF_CE_TN,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/CE/GDS4103_New_DF_CE_TN.csv",row.names = F)

write.csv(New_DF_TBE,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/LMO-UME/GDS4103_New_DF_TBE.csv",row.names = F)
write.csv(New_DF_TBE_NT,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/LMO-UME/GDS4103_New_DF_TBE_NT.csv",row.names = F)
write.csv(New_DF_TBE_TN,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/LMO-UME/GDS4103_New_DF_TBE_TN.csv",row.names = F)

write.csv(New_DF_BBE,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/UMO-LME/GDS4103_New_DF_BBE.csv",row.names = F)
write.csv(New_DF_BBE_NT,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/UMO-LME/GDS4103_New_DF_BBE_NT.csv",row.names = F)
write.csv(New_DF_BBE_TN,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/UMO-LME/GDS4103_New_DF_BBE_TN.csv",row.names = F)

############################################################
#Writing Partial Overlap DF to a CSV File                     
write.csv(New_DF_PO,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Significant-Patterns/PO/GDS4103_New_DF_PO.csv",row.names = F)
write.csv(New_DF_PO_NT,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Significant-Patterns/PO/GDS4103_New_DF_PO_NT.csv",row.names = F)
write.csv(New_DF_PO_TN,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Significant-Patterns/PO/GDS4103_New_DF_PO_TN.csv",row.names = F)
length(New_DF_PO)
length(New_DF_PO_NT)
length(New_DF_PO_TN)
...
n<-rbind(n,po2)                  
write.csv(a,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/EO/GDS4103_EO_DF_Min-Max.csv",row.names = F)

write.csv(b,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/CE/GDS4103_CE_DF_Min-Max.csv",row.names = F)
write.csv(c,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/CE/GDS4103_CE_NT_DF_Min-Max.csv",row.names = F)
write.csv(d,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/CE/GDS4103_CE_TN_DF_Min-Max.csv",row.names = F)

write.csv(e,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/LMO-UME/GDS4103_TBE_DF_Min-Max.csv",row.names = F)
write.csv(f,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/LMO-UME/GDS4103_TBE_NT_DF_Min-Max.csv",row.names = F)
write.csv(g,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/LMO-UME/GDS4103_TBE_TN_DF_Min-Max.csv",row.names = F)

write.csv(h,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/UMO-LME/GDS4103_BBE_DF_Min-Max.csv",row.names = F)
write.csv(j,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/UMO-LME/GDS4103_BBE_NT_DF_Min-Max.csv",row.names = F)
write.csv(k,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Insignificant-Patterns/UMO-LME/GDS4103_BBE_TN_DF_Min-Max.csv",row.names = F)

write.csv(l,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Significant-Patterns/PO/GDS4103_PO_DF_Min-Max.csv",row.names = F)
write.csv(m,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Significant-Patterns/PO/GDS4103_PO_NT_DF_Min-Max.csv",row.names = F)
write.csv(n,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/Significant-Patterns/PO/GDS4103_PO_TN_DF_Min-Max.csv",row.names = F)
...
write.csv(Full_Run_Time,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS4103-PancreaticTumor/GDS4103-PancreaticTumor_54675genes_Full_Runtime.csv",row.names = F)
