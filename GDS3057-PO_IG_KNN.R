...
for(i in 1:25){
  ...
  classifier_knn <- knn(train = train_scale,test = test_scale,
                        cl = train_cl$Cancer.Presence,k = i)
  #classifier_knn
...
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/Significant-Patterns/PO/IG/GDS3057-PO_IG_KNN_5_Runs.csv",row.names = F)
...
# Writing to a CSV file
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/Significant-Patterns/PO/IG/GDS3057-PO_IG_KNN_10_Runs.csv",row.names = F)
...
# Writing to a CSV file
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/Significant-Patterns/PO/IG/GDS3057-PO_IG_KNN_15_Runs.csv",row.names = F)
