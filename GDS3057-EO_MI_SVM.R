...
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/MI/GDS3057-EO_MI_KNN_5_Runs.csv",row.names = F)
...
# Writing to a CSV file
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/MI/GDS3057-EO_MI_KNN_10_Runs.csv",row.names = F)
...
# Writing to a CSV file
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/Insignificant-Patterns/EO/MI/GDS3057-EO_MI_KNN_15_Runs.csv",row.names = F)
