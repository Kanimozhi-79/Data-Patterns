...
######################################
###       1.      "F:/Ph.D Work/R/Coding/GDS3324-BreastCancer/GDS3324-BreastCancer_1_8377genes.csv"
###       2.      "F:/Ph.D Work/R/Coding/GDS3324-BreastCancer/GDS3324-BreastCancer_2_8541genes.csv"
###       3.      "F:/Ph.D Work/R/Coding/GDS3324-BreastCancer/GDS3324-BreastCancer_3_5359genes.csv"
...
###               Normal--  57:66
start_time <- Sys.time()
inputdata1<-read.csv("E:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Relief_FULL/GDS3324-FULL_Relief_Top5_genes.csv",header=TRUE)

inputdata1<-inputdata1[,-6]
ncol(inputdata1)
...
New_DF_EO=data.frame(matrix(NA,nrow=66,ncol=0))

New_DF_CE=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_CE_NT=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_CE_TN=data.frame(matrix(NA,nrow=66,ncol=0))

New_DF_TBE=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_TBE_NT=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_TBE_TN=data.frame(matrix(NA,nrow=66,ncol=0))

New_DF_BBE=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_BBE_NT=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_BBE_TN=data.frame(matrix(NA,nrow=66,ncol=0))
...
New_DF_PO=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_Names=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_PO_TN=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_PO_NT=data.frame(matrix(NA,nrow=66,ncol=0))

# Creating new DataFrame to append cOMPLETELY separation classes
#change nrow when Dataset changed
New_DF_TBBO=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_TBBO_Names=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_TBBO_TN=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_TBBO_NT=data.frame(matrix(NA,nrow=66,ncol=0))

# Creating new DataFrame to append cOMPLETELY separation classes
#change nrow when Dataset changed
New_DF_CS=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_CS_Names=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_CS_NT=data.frame(matrix(NA,nrow=66,ncol=0))
New_DF_CS_TN=data.frame(matrix(NA,nrow=66,ncol=0))
...
for(i in 1:cols){ #n Number of features
  Tumor_min<-round(min(inputdata1[1:56,i]),digits=1) #No of Tumor Samples
  Tumor_max<-round(max(inputdata1[1:56,i]),digits=1)
  Tumor_min=as.numeric(Tumor_min)
  Tumor_max=as.numeric(Tumor_max)
  
  Normal_min<-round(min(inputdata1[57:66,i]),digits=1) #No of Normal Samples
  Normal_max<-round(max(inputdata1[57:66,i]),digits=1)
...
Gene_Num_Summary
#write.csv(Gene_Num_Summary,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/GDS3324_Gene_Summary_DF.csv",row.names = F)
...
DF_Summary
#write.csv(DF_Summary,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/GDS3324_DF_Summary.csv",row.names = F)
...
DF_Summary_Sub
#write.csv(DF_Summary_Sub,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/GDS3324_DF_Summary_Sub_Summary.csv",row.names = F)
...
PO_DF_Summary
write.csv(PO_DF_Summary,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Significant-Patterns/PO/GDS3324_PO_DF_Summary.csv",row.names = F)
...
write.csv(po1,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Significant-Patterns/PO/GDS3324_PO_MinMax_Vectors_NT.csv",row.names = F)
length(po1)
...
write.csv(po2,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Significant-Patterns/PO/GDS3324_PO_MinMax_Vectors_TN.csv",row.names = F)
length(po2)
...
write.csv(po,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Significant-Patterns/PO/GDS3324_PO_MinMax_Vectors.csv",row.names = F)
length(po)
...
write.csv(eo,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/EO/GDS3324_EO_MinMax_Vectors.csv",row.names = F)
length(eo)
...
write.csv(ce1,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/CE/GDS3324_CE_MinMax_Vectors_NT.csv",row.names = F)
length(ce1)
...
write.csv(ce2,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/CE/GDS3324_CE_MinMax_Vectors_TN.csv",row.names = F)
length(ce2)
...
write.csv(ce,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/CE/GDS3324_CE_MinMax_Vectors.csv",row.names = F)
length(ce)
...
write.csv(tbe1,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/LMO-UME/GDS3324_LMO-UME_MinMax_Vectors_NT.csv",row.names = F)
length(tbe1)
...
write.csv(tbe2,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/LMO-UME/GDS3324_LMO-UME_MinMax_Vectors_TN.csv",row.names = F)
length(tbe2)
...
write.csv(tbe,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/LMO-UME/GDS3324_LMO-UME_MinMax_Vectors.csv",row.names = F)
length(tbe)
...
write.csv(bbe1,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/UMO-LME/GDS3324_UMO-LME_MinMax_Vectors_NT.csv",row.names = F)
length(bbe1)
...
write.csv(bbe2,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/UMO-LME/GDS3324_UMO-LME_MinMax_Vectors_TN.csv",row.names = F)
length(bbe2)
...
write.csv(bbe,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/UMO-LME/GDS3324_UMO-LME_MinMax_Vectors_TN.csv",row.names = F)
length(bbe)
...
write.csv(New_DF_EO,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/EO/GDS3324_New_DF_EO.csv",row.names = F)

write.csv(New_DF_CE,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/CE/GDS3324_New_DF_CE.csv",row.names = F)
write.csv(New_DF_CE_NT,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/CE/GDS3324_New_DF_CE_NT.csv",row.names = F)
write.csv(New_DF_CE_TN,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/CE/GDS3324_New_DF_CE_TN.csv",row.names = F)

write.csv(New_DF_TBE,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/LMO-UME/GDS3324_New_DF_TBE.csv",row.names = F)
write.csv(New_DF_TBE_NT,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/LMO-UME/GDS3324_New_DF_TBE_NT.csv",row.names = F)
write.csv(New_DF_TBE_TN,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/LMO-UME/GDS3324_New_DF_TBE_TN.csv",row.names = F)

write.csv(New_DF_BBE,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/UMO-LME/GDS3324_New_DF_BBE.csv",row.names = F)
write.csv(New_DF_BBE_NT,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/UMO-LME/GDS3324_New_DF_BBE_NT.csv",row.names = F)
write.csv(New_DF_BBE_TN,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/UMO-LME/GDS3324_New_DF_BBE_TN.csv",row.names = F)

############################################################
#Writing Partial Overlap DF to a CSV File                     
write.csv(New_DF_PO,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Significant-Patterns/PO/GDS3324_New_DF_PO.csv",row.names = F)
write.csv(New_DF_PO_NT,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Significant-Patterns/PO/GDS3324_New_DF_PO_NT.csv",row.names = F)
write.csv(New_DF_PO_TN,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Significant-Patterns/PO/GDS3324_New_DF_PO_TN.csv",row.names = F)
length(New_DF_PO)
length(New_DF_PO_NT)
length(New_DF_PO_TN)
...
n<-rbind(n,po2)                  
write.csv(a,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/EO/GDS3324_EO_DF_Min-Max.csv",row.names = F)

write.csv(b,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/CE/GDS3324_CE_DF_Min-Max.csv",row.names = F)
write.csv(c,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/CE/GDS3324_CE_NT_DF_Min-Max.csv",row.names = F)
write.csv(d,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/CE/GDS3324_CE_TN_DF_Min-Max.csv",row.names = F)

write.csv(e,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/LMO-UME/GDS3324_TBE_DF_Min-Max.csv",row.names = F)
write.csv(f,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/LMO-UME/GDS3324_TBE_NT_DF_Min-Max.csv",row.names = F)
write.csv(g,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/LMO-UME/GDS3324_TBE_TN_DF_Min-Max.csv",row.names = F)

write.csv(h,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/UMO-LME/GDS3324_BBE_DF_Min-Max.csv",row.names = F)
write.csv(j,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/UMO-LME/GDS3324_BBE_NT_DF_Min-Max.csv",row.names = F)
write.csv(k,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Insignificant-Patterns/UMO-LME/GDS3324_BBE_TN_DF_Min-Max.csv",row.names = F)

write.csv(l,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Significant-Patterns/PO/GDS3324_PO_DF_Min-Max.csv",row.names = F)
write.csv(m,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Significant-Patterns/PO/GDS3324_PO_NT_DF_Min-Max.csv",row.names = F)
write.csv(n,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/Significant-Patterns/PO/GDS3324_PO_TN_DF_Min-Max.csv",row.names = F)

end_time <- Sys.time()
time=end_time-start_time
time
Full_Run_Time<-data.frame(Pattern_Categorization_Time=inner_time,Full_Run_Time=time)
write.csv(Full_Run_Time,"F:/Ph.D Work/R/Coding-Towards Perfection/GDS3324-BreastCancer/GDS3324-BreastCancer_22277genes_Full_Runtime.csv",row.names = F)
