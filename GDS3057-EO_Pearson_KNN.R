...
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/Pearson/GDS3057-EO_Pearson_KNN_5_Runs.csv",row.names = F)
...
# Writing to a CSV file
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/Pearson/GDS3057-EO_Pearson_KNN_10_Runs.csv",row.names = F)
...
# Writing to a CSV file
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/Pearson/GDS3057-EO_Pearson_KNN_15_Runs.csv",row.names = F)
