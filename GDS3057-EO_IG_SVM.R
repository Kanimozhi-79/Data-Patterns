...
# cancerdata <- read.csv("E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/IG/GDS3057-EO_IG_Top5_genes.csv",header = TRUE)
# cancerdata <- read.csv("E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/IG/GDS3057-EO_IG_Top10_genes.csv",header = TRUE)
# cancerdata <- read.csv("E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/IG/GDS3057-EO_IG_Top15_genes.csv",header = TRUE)
# cancerdata <- read.csv("E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/IG/GDS3057-EO_IG_Top20_genes.csv",header = TRUE)
# cancerdata <- read.csv("E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/IG/GDS3057-EO_IG_Top25_genes.csv",header = TRUE)
...
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/IG/GDS3057-EO_IG_SVM_5_Runs.csv",row.names = F)
...
# time_estimate<-data.frame(Pattern="GDS3057_EO_IG_SVM",Runtime_10genes=time)
# write.csv(time_estimate,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/IG/GDS3057-EO_IG_SVM_10g_Runtime.csv",row.names=F)
# 
...
# Writing to a CSV file
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/IG/GDS3057-EO_IG_SVM_10_Runs.csv",row.names = F)
...
# time_estimate<-data.frame()
# time_estimate<-data.frame(Pattern="GDS3057_EO_IG_SVM",Runtime_15genes=time)
# write.csv(time_estimate,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/IG/GDS3057-EO_IG_SVM_Runtime.csv",row.names=F)
...
# Writing to a CSV file
###############################
write.csv(Vec_SVM_5_DF,"E:/Ph.D Work/R/Coding-Towards Perfection/GDS3057-Leukemia/InSignificant-Patterns/EO/IG/GDS3057-EO_IG_SVM_15_Runs.csv",row.names = F)
